...
#pod   appended.
#pod * C<allow_credentialed_redirects> - If a 3xx redirects to a different scheme,
...
#pod * C<allow_downgrade> — If a 3xx redirect changes the scheme from C<https> to
#pod   plain C<http>, HTTP::Tiny will by default refuse to follow it, returning the
#pod   3xx response. Set this to a true value to revert to the legacy behavior of
